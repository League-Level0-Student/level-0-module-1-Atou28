...
public class SecretMessageBox {
	...
	public static void main(String[] args) {
		...
		String secretPasscode = "Amazing League of Programmers!";
		...
		JOptionPane.showInputDialog("You may only see the secret message by typing the passcode!!");
		// 4. If their guess matches the password, show them the secret message
		if (secretPasscode.equals(secretMessage)) {
